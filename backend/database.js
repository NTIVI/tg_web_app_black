    ...
    try {
        ...
        if (parseInt(questRows[0].count) === 0) {
            const defaultQuests = [
                ...
                ['daily_win_5', 'Везунчик', 'Выиграйте в играх 5 раз', 1000, 5, 'daily', 'win'],
                ['daily_ads_5', 'Зритель', 'Посмотрите 5 рекламных роликов', 750, 5, 'daily', 'ads'],
                ['daily_bet_1000', 'Крупный игрок', 'Поставьте в сумме более 1000 монет', 1500, 1000, 'daily', 'bet'],
                ['weekly_games_100', 'Легенда казино', 'Сыграйте 100 раз за неделю', 5000, 100, 'weekly', 'games'],
                ['weekly_win_50', 'Король удачи', 'Выиграйте 50 раз за неделю', 10000, 50, 'weekly', 'win'],
